...
def main() -> None:
    ...
    # Cut four true transparent 4:3 photo windows and add print-safe outlines.
    for index, slot in enumerate(SLOTS, start=1):
        ...
        draw.text((30, (slot[1] + slot[3]) // 2), f"0{index}", font=font(20), fill=(23, 23, 17, 255), anchor="mm")
